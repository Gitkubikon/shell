...
Singleton {
    ...
    readonly property string temp: Config.services.isMetric ? `${cc?.tempC ?? 0}°C` : `${cc?.tempF ?? 0}°F`
    readonly property string feelsLike: Config.services.isMetric ? `${cc?.feelsLikeC ?? 0}°C` : `${cc?.feelsLikeF ?? 0}°F`
